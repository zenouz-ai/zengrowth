...
- Generated materials: `MATERIALS_RETENTION_DAYS` (default 30). Purge is opt-in via
  `MATERIALS_RETENTION_PURGE_ENABLED` (or the manual CLI); see
  [MATERIAL_GENERATION.md](MATERIAL_GENERATION.md).
