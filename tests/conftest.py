...
def isolate_provider_credentials(monkeypatch: pytest.MonkeyPatch) -> Iterator[None]:
    """Keep tests from inheriting developer credentials or making live API calls."""
    for name in ("ANTHROPIC_API_KEY", "TAVILY_API_KEY", "OPENAI_API_KEY"):
