"""Import-type hints and close-out learning extraction (Northwind / fabrikam replay)."""
...
def test_suggest_none_for_generic_briefing():
    assert suggest_internal_material_type("Northwind research pack", "# Northwind\n\nBusiness overview...") is None
...
def test_title_rules_do_not_scan_body():
    ...
    assert suggest_internal_material_type("Northwind research pack", body) is None
