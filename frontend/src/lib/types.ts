...
export interface CloseoutLearningCandidate {
  category: string
  claim_text: string
  source_title: string | null
}

export interface CloseoutLearnings {
  candidates: CloseoutLearningCandidate[]
}

export interface CloseoutPromoteResult {
  promoted: number
