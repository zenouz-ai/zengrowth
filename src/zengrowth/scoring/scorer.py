...
class InstrumentedScorer:
    ...
    def score(self, system: str, user: str, model: str) -> dict[str, Any]:
        parsed = self._llm.chat_json(
            ...
            # Older models receive temperature 0. Adaptive-thinking models that
            # reject custom sampling use their provider default; the persisted
            # rationale and frozen calibration gates keep scoring auditable.
            temperature=0.0,
        )
