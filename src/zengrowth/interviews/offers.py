...
from .material_policy import line_count, material_allows_web, missing_sections
    ...
    *,
    ...
    with pipeline_run(
        ...
        markdown, citations, web_used = client.generate_document(
            ...
            allow_web=material_allows_web("offer_evaluation"),
        )
    ...
    *,
    ...
    with pipeline_run(
        ...
        markdown, citations, web_used = client.generate_document(
            ...
            allow_web=material_allows_web("onboarding_pack"),
        )
        markdown = _strip_code_fence(markdown)
        if not markdown.strip():
    ...
    *,
    ...
    with pipeline_run(
        ...
        markdown, _citations, _web = client.generate_document(
            ...
            allow_web=material_allows_web("offer_response"),
        )
        markdown = _strip_code_fence(markdown)
        if not markdown.strip():
