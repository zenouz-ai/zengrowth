...
Operator journey replay (INT-06) found two filing mistakes that made the learning loop
...
def apply_import_type_suggestion(
    ...
    one of the replay misfiles. Explicit interviewer/debrief/etc. choices stick.
    """
