...
<p align="center">
  ...
  It discovers and scores senior AI and Data-Science roles, grounds application materials in reviewed evidence,
...
- **Explainable scoring.** One strict-JSON Claude call returns per-dimension scores, a stored rationale, and an observable-fit priority score. Frozen calibration fixtures protect the ranking logic; live provider outputs are not claimed to be identical across runs. → [`docs/SCORING_AND_EXPECTED_VALUE.md`](docs/SCORING_AND_EXPECTED_VALUE.md)
